...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'BuildWebGL.data';
    var REMOTE_PACKAGE_BASE = 'BuildWebGL.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 12965309;
      var PACKAGE_UUID = 'fbddc057-aa99-4823-918d-541a12ec60db';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 9859402, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(9859402, 9859423, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(9859423, 11440991, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(11440991, 12937683, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(12937683, 12965309, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_BuildWebGL.data');

    };
    Module['addRunDependency']('datafile_BuildWebGL.data');
